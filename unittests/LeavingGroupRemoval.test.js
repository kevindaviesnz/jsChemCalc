...
test('testing leaving group removal', () => {

   const molecules = RemoveLeavingGroup(molecule_with_water_leaving_group, logger)
   expect(molecules[0].canonicalSmiles).toBe('CC[C+]C')
